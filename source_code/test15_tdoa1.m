...
% figure
mlrankest(G2);hold on
% mlrankest(Sigma2_x);hold on
% mlrankest(Sigma2_y);hold on
% mlrankest(Sigma2_z);hold on
...
save_path = ['test15_data/tdoa1/',ContrastAlgorithm,'/fs_10_ratio_',num2str(NAN_ratio),'/'];
...
incomplete_T2 = sub_G2+ERR*randn(size(sub_G2));
