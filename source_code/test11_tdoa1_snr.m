...
%             G2(j,i,k) = sqrt(G_eq);
%             Sigma2_x(j,i,k) = sqrt(Gx_eq);
%             Sigma2_y(j,i,k) = sqrt(Gy_eq);
%             Sigma2_z(j,i,k) = sqrt(Gz_eq);
%         end
%     end
% end
% figure
...
% Algorithm_list = {'kriging','GeneralGDOP','RBF','GeneralBTD','GeneralGDOP2','Proposed'};
...
save_path = ['test11_data/tdoa1/',ContrastAlgorithm,'/fs_10_snr_',ERR_list{index_list},'/'];
