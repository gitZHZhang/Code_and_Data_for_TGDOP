...
% for snr_idx = 1:1:length(SNR_LIST)-1
    ...
    save_path = ['test5_data/scene2/err_',num2str(err),'_SNR_',num2str(SNR_PARA),'/'];
    ...
    for iter = 1:1:Mont_times
        ...
        cov12_initial = cov12_real+cov12_real*10^(-SNR_PARA/20)*randn;
        ...
        for i=1:1:size(meas_matrix,1)
            ...
            G_Cal = subs(G_eq, eta12*sigmat1*sigmat2,cov12_initial);
    ...
    res_all = [sigmat1_list;sigmat2_list;sigmat3_list;sigmas_list;eta12_list;eta13_list;eta23_list];
