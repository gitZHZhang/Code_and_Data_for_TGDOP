...
%% 加载原始数据（和test4的数据相同）
load test12_data/tdoa1/G2.mat 
load test12_data/tdoa1/Sigma2_x.mat
load test12_data/tdoa1/Sigma2_y.mat 
load test12_data/tdoa1/Sigma2_z.mat
%% 传感器位置
L=30;
xt = 0;yt = 0;zt = 0;
...
save_path = ['test12_data/tdoa1/',ContrastAlgorithm,'/fs_10_ratio_',num2str(NAN_ratio),'/'];
