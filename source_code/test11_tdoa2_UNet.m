...
%% 按照比例抽取部分G作为观测量
influence_trigger = 'Ratio'; % ERR or Ratio

out_path0 = 'test11_data/tdoa2/';
CHOSEN_IDX_LIST = [];
Mont_times = 50;
NAN_ratio_0 = 0.99;
err_0 = 0.01;
...
if strcmp(influence_trigger,'ERR')
%% ERR对UNet算法的影响%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for err_idx = 1:1:length(ERR_list)
    ...
    if strcmp(mode,'train')
        ...
        save_path = [out_path0,ContrastAlgorithm,'/fs_10_err_',num2str(err),'/'];
    ...
    if strcmp(mode,'evaluate')
        ...
        frob_list_all_Mont = [];
        for i=1:1:size(G2,3)
            read_path = [out_path0,ContrastAlgorithm,'/fs_10_err_',num2str(err),'/','outdata/z_',num2str(i)];
