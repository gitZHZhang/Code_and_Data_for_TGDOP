function [sol,output] = runBTD_MultiInput(tensor,MLrank_mat,poly,type)
tensor1 = tensor{1};
tensor2 = tensor{2};
tensor3 = tensor{3};
size_tens = tensor1.size;
L1 = MLrank_mat(1,:);
L2 = MLrank_mat(2,:);
L3 = MLrank_mat(3,:);
model= struct;
...
model.factorizations.mybtd1.data=tensor1;
model.factorizations.mybtd1.btd={{1,2,3,4}};
model.factorizations.mybtd2.data=tensor2;
model.factorizations.mybtd2.btd={{5,6,7,8}};
model.factorizations.mybtd3.data=tensor3;
