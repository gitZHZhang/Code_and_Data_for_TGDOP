...
%% 加载原始数据（和test4的数据相同）
load test11_data/tdoa2/G2.mat 
load test11_data/tdoa2/Sigma2_x.mat
load test11_data/tdoa2/Sigma2_y.mat 
load test11_data/tdoa2/Sigma2_z.mat
...
Algorithm_list = {'kriging','GeneralGDOP','RBF','NNM-T','Proposed','GeneralBTD'};
% Algorithm_list = {'kriging','GeneralGDOP','RBF','NNM-T','GeneralBTD'};
...
save_path = ['test11_data/tdoa2/',ContrastAlgorithm,'/fs_10_ratio_',num2str(NAN_ratio),'/'];
% save_path = ['test11_data/tdoa2/',ContrastAlgorithm,'/fs_10_err_',ERR_list{index_list},'/'];%TTTTTTTTTTTTTTTTTT
